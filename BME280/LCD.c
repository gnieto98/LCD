 ...
 * LCD.c
 *
 * Created: 17/11/2024 05:42:02 a. m.
 *  Author: nieto
 */ 
...
{
	/* configure the microprocessor pins for the data lines as outputs*/
	lcd_Data_DDR |= (1<<lcd_D7_bit) | (1<<lcd_D6_bit) | (1<<lcd_D5_bit) | (1<<lcd_D4_bit);
	
	/* configure the microprocessor pins for the control lines as outputs */
